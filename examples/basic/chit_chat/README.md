...
export MDB_DB_NAME="conversations_db"
export MDB_JWT_SECRET="your-secret-key-here"
...
engine = MongoDBEngine(
    mongo_uri=os.getenv("MDB_MONGO_URI"),
...
2. Check MDB_MONGO_URI environment variable
