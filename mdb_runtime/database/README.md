...
The database module is part of MDB_RUNTIME. No additional installation required.
...
```python
from mdb_runtime.database import get_shared_mongo_client
...
```python
from mdb_runtime.database import get_pool_metrics
...
```python
from mdb_runtime.database import verify_shared_client
...
```python
from mdb_runtime.database import AppDB, Collection, get_app_db
...
```python
from mdb_runtime.database import Collection
...
from mdb_runtime.constants import AUTO_INDEX_HINT_THRESHOLD
...
from mdb_runtime.database import get_app_db, AppDB
from mdb_runtime.core import RuntimeEngine
