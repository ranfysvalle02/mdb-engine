...
Internal utility functions for validation and error handling in MDB_RUNTIME. These are helper functions used internally by other modules.
...
The utils module is part of MDB_RUNTIME. No additional installation required.

## Note

These utilities are primarily for **internal use** by MDB_RUNTIME modules. They are documented here for reference, but most users will interact with them indirectly through other modules.
...
```python
from mdb_runtime.utils.validation import validate_collection_name
...
```python
from mdb_runtime.utils.validation import validate_app_slug
...
```python
from mdb_runtime.utils.validation import validate_mongo_uri
...
```python
from mdb_runtime.utils.decorators import handle_mongo_errors
...
```python
from mdb_runtime.utils.decorators import require_initialized
...
```python
from mdb_runtime.utils.validation import validate_collection_name, validate_app_slug
