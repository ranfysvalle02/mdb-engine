...
High-level index creation and management orchestration for MDB_RUNTIME applications. Supports all MongoDB index types including regular, TTL, partial, text, geospatial, vector search, and Atlas Search indexes.
...
The indexes module is part of MDB_RUNTIME. No additional installation required.
...
```python
from mdb_runtime.indexes.helpers import normalize_keys, keys_to_dict
...
```python
from mdb_runtime.indexes.helpers import (
    is_id_index,
