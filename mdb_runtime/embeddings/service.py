...
class OpenAIEmbeddingProvider(BaseEmbeddingProvider):
    ...
    def __init__(self, api_key: Optional[str] = None, default_model: str = "text-embedding-3-small"):
        """
...
class AzureOpenAIEmbeddingProvider(BaseEmbeddingProvider):
    ...
    def __init__(
        ...
        Args:
            ...
            api_version: API version (defaults to AZURE_OPENAI_API_VERSION or OPENAI_API_VERSION env var)
            default_model: Default embedding model/deployment name (default: "text-embedding-3-small")
        """
        if not OPENAI_AVAILABLE:
            raise EmbeddingServiceError(
                "OpenAI SDK not available. Install with: pip install openai"
        ...
        api_version = api_version or os.getenv("AZURE_OPENAI_API_VERSION") or os.getenv("OPENAI_API_VERSION", "2024-02-15-preview")
...
class EmbeddingProvider:
    ...
    Example:
        ...
        from mdb_runtime.embeddings import OpenAIEmbeddingProvider
...
def get_embedding_service(
    ...
    Example:
        ...
        embedding_service = get_embedding_service(
            config={"max_tokens_per_chunk": 1000, "default_embedding_model": "text-embedding-3-small"}
        )
    """
