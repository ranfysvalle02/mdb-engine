...
def get_embedding_service_for_app(
    ...
    Example:
        ...
        from mdb_runtime.embeddings.dependencies import get_embedding_service_for_app
...
def create_embedding_dependency(app_slug: str, engine: Optional[Any] = None):
    ...
    Example:
        ```python
        from fastapi import Depends
        from mdb_runtime.embeddings.dependencies import create_embedding_dependency
...
def get_embedding_service_dependency(app_slug: str):
    ...
    Example:
        ...
        from mdb_runtime.embeddings.dependencies import set_global_engine, get_embedding_service_dependency
