...
The central orchestration engine for MDB_RUNTIME that manages database connections, app registration, manifest validation, index management, and resource lifecycle.
...
The core module is part of MDB_RUNTIME. No additional installation required.
...
```python
from mdb_runtime.observability import check_engine_health, check_mongodb_health
...
```python
from mdb_runtime.core import ManifestValidator, validate_manifest
...
```python
from mdb_runtime.core import ManifestParser
...
```python
from mdb_runtime.core import migrate_manifest, get_schema_version
...
```python
from mdb_runtime.core import validate_manifests_parallel
...
```python
from mdb_runtime.core import clear_validation_cache
...
```python
from mdb_runtime.core import validate_manifest_with_db
...
```python
from mdb_runtime.exceptions import InitializationError
