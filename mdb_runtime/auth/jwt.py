...
from ..constants import ACCESS_TOKEN_TTL, REFRESH_TOKEN_TTL, CURRENT_TOKEN_VERSION
from ..config import ACCESS_TOKEN_TTL as CONFIG_ACCESS_TTL, REFRESH_TOKEN_TTL as CONFIG_REFRESH_TTL
