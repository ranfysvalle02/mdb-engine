...
class MultiAppMixin:
    ...
    async def create_multi_app(  # noqa: C901
        self,
        ...
        **fastapi_kwargs: Any,
        ...
        if apps_dir and apps is None:
            ...
            apps = await asyncio.to_thread(
                self._discover_apps_from_directory,
                apps_dir=apps_dir,
        ...
        if multi_app_manifest:
            ...
            multi_app_config = await asyncio.to_thread(_read_json_file, manifest_path)
        ...
        if validate:
            validation_errors = await self._validate_manifests(apps, strict)
        ...
        async def lifespan(app: FastAPI):  # noqa: C901
            ...
            for app_config in apps:
                ...
                try:
                    ...
                    try:
                        await asyncio.to_thread(self._import_app_routes, child_app, manifest_path, slug)
                    except (
                        ValueError,
                        TypeError,
                        AttributeError,
