...
class SharedUserPool:
    ...
    def __init__(
        ...
        from ..env import get_env, get_jwt_secret

        self._jwt_secret = jwt_secret or get_jwt_secret()
        self._jwt_public_key = jwt_public_key or get_env(
            "MDB_ENGINE_JWT_PUBLIC_KEY",
        )
